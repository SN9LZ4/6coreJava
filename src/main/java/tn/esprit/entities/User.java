...
public class User {
    ...
    public int getGoogle_id() { return google_id; }
    public int getBanned_at() { return banned_at; }
    public int getNblogin() { return nblogin; }
    public String getVerification_twilio() { return verification_twilio; }
    ...
    public void setGoogle_id(int google_id) { this.google_id = google_id; }
    public void setBanned_at(int banned_at) { this.banned_at = banned_at; }
    public void setNblogin(int nblogin) { this.nblogin = nblogin; }
    public void setVerification_twilio(String verification_twilio) { this.verification_twilio = verification_twilio; }
